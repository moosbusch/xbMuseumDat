...
public class DisplayCreationLocationDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.DisplayCreationLocationDocument
{
    ...
    public de.zib.museum.museumdat.DisplayCreationLocationDocument.DisplayCreationLocation getDisplayCreationLocation()
    {
        synchronized (monitor())
        {
            ...
            target = (de.zib.museum.museumdat.DisplayCreationLocationDocument.DisplayCreationLocation)get_store().find_element_user(DISPLAYCREATIONLOCATION$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public de.zib.museum.museumdat.DisplayCreationLocationDocument.DisplayCreationLocation addNewDisplayCreationLocation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.DisplayCreationLocationDocument.DisplayCreationLocation target = null;
            target = (de.zib.museum.museumdat.DisplayCreationLocationDocument.DisplayCreationLocation)get_store().add_element_user(DISPLAYCREATIONLOCATION$0);
            return target;
        }
    }
    /**
