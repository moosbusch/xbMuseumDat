 ...
 */
public class ResourceSourceDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.ResourceSourceDocument
{
     ...
     */
    public de.zib.museum.museumdat.ResourceSourceDocument.ResourceSource getResourceSource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ResourceSourceDocument.ResourceSource target = null;
            target = (de.zib.museum.museumdat.ResourceSourceDocument.ResourceSource)get_store().find_element_user(RESOURCESOURCE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setResourceSource(de.zib.museum.museumdat.ResourceSourceDocument.ResourceSource resourceSource)
    {
    ...
    public de.zib.museum.museumdat.ResourceSourceDocument.ResourceSource addNewResourceSource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ResourceSourceDocument.ResourceSource target = null;
            target = (de.zib.museum.museumdat.ResourceSourceDocument.ResourceSource)get_store().add_element_user(RESOURCESOURCE$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class ResourceSourceImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.ResourceSourceDocument.ResourceSource
    {
        private static final long serialVersionUID = 1L;
