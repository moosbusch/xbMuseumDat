 ...
 */
public class ResourceMetadataLocDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.ResourceMetadataLocDocument
{
     ...
     */
    public de.zib.museum.museumdat.ResourceMetadataLocDocument.ResourceMetadataLoc getResourceMetadataLoc()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ResourceMetadataLocDocument.ResourceMetadataLoc target = null;
            target = (de.zib.museum.museumdat.ResourceMetadataLocDocument.ResourceMetadataLoc)get_store().find_element_user(RESOURCEMETADATALOC$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setResourceMetadataLoc(de.zib.museum.museumdat.ResourceMetadataLocDocument.ResourceMetadataLoc resourceMetadataLoc)
    {
    ...
    public de.zib.museum.museumdat.ResourceMetadataLocDocument.ResourceMetadataLoc addNewResourceMetadataLoc()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ResourceMetadataLocDocument.ResourceMetadataLoc target = null;
            target = (de.zib.museum.museumdat.ResourceMetadataLocDocument.ResourceMetadataLoc)get_store().add_element_user(RESOURCEMETADATALOC$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class ResourceMetadataLocImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.ResourceMetadataLocDocument.ResourceMetadataLoc
    {
        private static final long serialVersionUID = 1L;
