 ...
 */
public class SourceNameActorDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.SourceNameActorDocument
{
    private static final long serialVersionUID = 1L;
    
    public SourceNameActorDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName SOURCENAMEACTOR$0 = 
     ...
     */
    public de.zib.museum.museumdat.SourceNameActorDocument.SourceNameActor getSourceNameActor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.SourceNameActorDocument.SourceNameActor target = null;
            target = (de.zib.museum.museumdat.SourceNameActorDocument.SourceNameActor)get_store().find_element_user(SOURCENAMEACTOR$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setSourceNameActor(de.zib.museum.museumdat.SourceNameActorDocument.SourceNameActor sourceNameActor)
    {
        generatedSetterHelperImpl(sourceNameActor, SOURCENAMEACTOR$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public de.zib.museum.museumdat.SourceNameActorDocument.SourceNameActor addNewSourceNameActor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.SourceNameActorDocument.SourceNameActor target = null;
            target = (de.zib.museum.museumdat.SourceNameActorDocument.SourceNameActor)get_store().add_element_user(SOURCENAMEACTOR$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class SourceNameActorImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.SourceNameActorDocument.SourceNameActor
    {
        private static final long serialVersionUID = 1L;
        
        public SourceNameActorImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected SourceNameActorImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
