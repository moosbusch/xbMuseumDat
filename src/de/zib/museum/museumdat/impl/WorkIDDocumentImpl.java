 ...
 */
public class WorkIDDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.WorkIDDocument
{
     ...
     */
    public de.zib.museum.museumdat.WorkIDDocument.WorkID getWorkID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.WorkIDDocument.WorkID target = null;
            target = (de.zib.museum.museumdat.WorkIDDocument.WorkID)get_store().find_element_user(WORKID$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setWorkID(de.zib.museum.museumdat.WorkIDDocument.WorkID workID)
    {
    ...
    public de.zib.museum.museumdat.WorkIDDocument.WorkID addNewWorkID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.WorkIDDocument.WorkID target = null;
            target = (de.zib.museum.museumdat.WorkIDDocument.WorkID)get_store().add_element_user(WORKID$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class WorkIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.WorkIDDocument.WorkID
    {
        private static final long serialVersionUID = 1L;
