...
public class DisplayMaterialsTechDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.DisplayMaterialsTechDocument
{
    ...
    public de.zib.museum.museumdat.DisplayMaterialsTechDocument.DisplayMaterialsTech getDisplayMaterialsTech()
    {
        synchronized (monitor())
        {
            ...
            target = (de.zib.museum.museumdat.DisplayMaterialsTechDocument.DisplayMaterialsTech)get_store().find_element_user(DISPLAYMATERIALSTECH$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public de.zib.museum.museumdat.DisplayMaterialsTechDocument.DisplayMaterialsTech addNewDisplayMaterialsTech()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.DisplayMaterialsTechDocument.DisplayMaterialsTech target = null;
            target = (de.zib.museum.museumdat.DisplayMaterialsTechDocument.DisplayMaterialsTech)get_store().add_element_user(DISPLAYMATERIALSTECH$0);
            return target;
        }
    }
    /**
