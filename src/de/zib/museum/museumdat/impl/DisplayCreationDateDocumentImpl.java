 ...
 */
public class DisplayCreationDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.DisplayCreationDateDocument
{
    ...
    public de.zib.museum.museumdat.DisplayCreationDateDocument.DisplayCreationDate getDisplayCreationDate()
    {
        synchronized (monitor())
        {
            ...
            target = (de.zib.museum.museumdat.DisplayCreationDateDocument.DisplayCreationDate)get_store().find_element_user(DISPLAYCREATIONDATE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public de.zib.museum.museumdat.DisplayCreationDateDocument.DisplayCreationDate addNewDisplayCreationDate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.DisplayCreationDateDocument.DisplayCreationDate target = null;
            target = (de.zib.museum.museumdat.DisplayCreationDateDocument.DisplayCreationDate)get_store().add_element_user(DISPLAYCREATIONDATE$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class DisplayCreationDateImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.DisplayCreationDateDocument.DisplayCreationDate
    {
        private static final long serialVersionUID = 1L;

        public DisplayCreationDateImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }

        protected DisplayCreationDateImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
