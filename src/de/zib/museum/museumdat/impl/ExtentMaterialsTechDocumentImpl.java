 ...
 */
public class ExtentMaterialsTechDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.ExtentMaterialsTechDocument
{
     ...
     */
    public de.zib.museum.museumdat.ExtentMaterialsTechDocument.ExtentMaterialsTech getExtentMaterialsTech()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ExtentMaterialsTechDocument.ExtentMaterialsTech target = null;
            target = (de.zib.museum.museumdat.ExtentMaterialsTechDocument.ExtentMaterialsTech)get_store().find_element_user(EXTENTMATERIALSTECH$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setExtentMaterialsTech(de.zib.museum.museumdat.ExtentMaterialsTechDocument.ExtentMaterialsTech extentMaterialsTech)
    {
        generatedSetterHelperImpl(extentMaterialsTech, EXTENTMATERIALSTECH$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public de.zib.museum.museumdat.ExtentMaterialsTechDocument.ExtentMaterialsTech addNewExtentMaterialsTech()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ExtentMaterialsTechDocument.ExtentMaterialsTech target = null;
            target = (de.zib.museum.museumdat.ExtentMaterialsTechDocument.ExtentMaterialsTech)get_store().add_element_user(EXTENTMATERIALSTECH$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class ExtentMaterialsTechImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.ExtentMaterialsTechDocument.ExtentMaterialsTech
    {
        private static final long serialVersionUID = 1L;
        
        public ExtentMaterialsTechImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected ExtentMaterialsTechImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
