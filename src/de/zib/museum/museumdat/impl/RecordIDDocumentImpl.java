 ...
 */
public class RecordIDDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.RecordIDDocument
{
     ...
     */
    public de.zib.museum.museumdat.RecordIDDocument.RecordID getRecordID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.RecordIDDocument.RecordID target = null;
            target = (de.zib.museum.museumdat.RecordIDDocument.RecordID)get_store().find_element_user(RECORDID$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setRecordID(de.zib.museum.museumdat.RecordIDDocument.RecordID recordID)
    {
     ...
     */
    public static class RecordIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.RecordIDDocument.RecordID
    {
        private static final long serialVersionUID = 1L;
