 ...
 */
public class RecordMetadataLocDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.RecordMetadataLocDocument
{
     ...
     */
    public de.zib.museum.museumdat.RecordMetadataLocDocument.RecordMetadataLoc getRecordMetadataLoc()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.RecordMetadataLocDocument.RecordMetadataLoc target = null;
            target = (de.zib.museum.museumdat.RecordMetadataLocDocument.RecordMetadataLoc)get_store().find_element_user(RECORDMETADATALOC$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setRecordMetadataLoc(de.zib.museum.museumdat.RecordMetadataLocDocument.RecordMetadataLoc recordMetadataLoc)
    {
    ...
    public de.zib.museum.museumdat.RecordMetadataLocDocument.RecordMetadataLoc addNewRecordMetadataLoc()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.RecordMetadataLocDocument.RecordMetadataLoc target = null;
            target = (de.zib.museum.museumdat.RecordMetadataLocDocument.RecordMetadataLoc)get_store().add_element_user(RECORDMETADATALOC$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class RecordMetadataLocImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.RecordMetadataLocDocument.RecordMetadataLoc
    {
        private static final long serialVersionUID = 1L;
