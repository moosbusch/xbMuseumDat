 ...
 */
public class DisplayStateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.DisplayStateDocument
{
     ...
     */
    public de.zib.museum.museumdat.DisplayStateDocument.DisplayState getDisplayState()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.DisplayStateDocument.DisplayState target = null;
            target = (de.zib.museum.museumdat.DisplayStateDocument.DisplayState)get_store().find_element_user(DISPLAYSTATE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setDisplayState(de.zib.museum.museumdat.DisplayStateDocument.DisplayState displayState)
    {
        generatedSetterHelperImpl(displayState, DISPLAYSTATE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
     ...
     */
    public static class DisplayStateImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.DisplayStateDocument.DisplayState
    {
        private static final long serialVersionUID = 1L;
        
        public DisplayStateImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected DisplayStateImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
