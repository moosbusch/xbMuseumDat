 ...
 */
public class SourceMaterialsTechDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.SourceMaterialsTechDocument
{
     ...
     */
    public de.zib.museum.museumdat.SourceMaterialsTechDocument.SourceMaterialsTech getSourceMaterialsTech()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.SourceMaterialsTechDocument.SourceMaterialsTech target = null;
            target = (de.zib.museum.museumdat.SourceMaterialsTechDocument.SourceMaterialsTech)get_store().find_element_user(SOURCEMATERIALSTECH$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setSourceMaterialsTech(de.zib.museum.museumdat.SourceMaterialsTechDocument.SourceMaterialsTech sourceMaterialsTech)
    {
        generatedSetterHelperImpl(sourceMaterialsTech, SOURCEMATERIALSTECH$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public de.zib.museum.museumdat.SourceMaterialsTechDocument.SourceMaterialsTech addNewSourceMaterialsTech()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.SourceMaterialsTechDocument.SourceMaterialsTech target = null;
            target = (de.zib.museum.museumdat.SourceMaterialsTechDocument.SourceMaterialsTech)get_store().add_element_user(SOURCEMATERIALSTECH$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class SourceMaterialsTechImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.SourceMaterialsTechDocument.SourceMaterialsTech
    {
        private static final long serialVersionUID = 1L;
        
        public SourceMaterialsTechImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected SourceMaterialsTechImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
