 ...
 */
public class StyleDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.StyleDocument
{
     ...
     */
    public de.zib.museum.museumdat.StyleDocument.Style getStyle()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.StyleDocument.Style target = null;
            target = (de.zib.museum.museumdat.StyleDocument.Style)get_store().find_element_user(STYLE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setStyle(de.zib.museum.museumdat.StyleDocument.Style style)
    {
     ...
     */
    public static class StyleImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.StyleDocument.Style
    {
        private static final long serialVersionUID = 1L;
