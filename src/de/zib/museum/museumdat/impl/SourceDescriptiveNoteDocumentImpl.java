 ...
 */
public class SourceDescriptiveNoteDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.SourceDescriptiveNoteDocument
{
     ...
     */
    public de.zib.museum.museumdat.SourceDescriptiveNoteDocument.SourceDescriptiveNote getSourceDescriptiveNote()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.SourceDescriptiveNoteDocument.SourceDescriptiveNote target = null;
            target = (de.zib.museum.museumdat.SourceDescriptiveNoteDocument.SourceDescriptiveNote)get_store().find_element_user(SOURCEDESCRIPTIVENOTE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setSourceDescriptiveNote(de.zib.museum.museumdat.SourceDescriptiveNoteDocument.SourceDescriptiveNote sourceDescriptiveNote)
    {
        generatedSetterHelperImpl(sourceDescriptiveNote, SOURCEDESCRIPTIVENOTE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public de.zib.museum.museumdat.SourceDescriptiveNoteDocument.SourceDescriptiveNote addNewSourceDescriptiveNote()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.SourceDescriptiveNoteDocument.SourceDescriptiveNote target = null;
            target = (de.zib.museum.museumdat.SourceDescriptiveNoteDocument.SourceDescriptiveNote)get_store().add_element_user(SOURCEDESCRIPTIVENOTE$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class SourceDescriptiveNoteImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.SourceDescriptiveNoteDocument.SourceDescriptiveNote
    {
        private static final long serialVersionUID = 1L;
        
        public SourceDescriptiveNoteImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected SourceDescriptiveNoteImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
