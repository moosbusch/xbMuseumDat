 ...
 */
public class LabelRelatedResourceDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.LabelRelatedResourceDocument
{
     ...
     */
    public de.zib.museum.museumdat.LabelRelatedResourceDocument.LabelRelatedResource getLabelRelatedResource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.LabelRelatedResourceDocument.LabelRelatedResource target = null;
            target = (de.zib.museum.museumdat.LabelRelatedResourceDocument.LabelRelatedResource)get_store().find_element_user(LABELRELATEDRESOURCE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setLabelRelatedResource(de.zib.museum.museumdat.LabelRelatedResourceDocument.LabelRelatedResource labelRelatedResource)
    {
        generatedSetterHelperImpl(labelRelatedResource, LABELRELATEDRESOURCE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public de.zib.museum.museumdat.LabelRelatedResourceDocument.LabelRelatedResource addNewLabelRelatedResource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.LabelRelatedResourceDocument.LabelRelatedResource target = null;
            target = (de.zib.museum.museumdat.LabelRelatedResourceDocument.LabelRelatedResource)get_store().add_element_user(LABELRELATEDRESOURCE$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class LabelRelatedResourceImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.LabelRelatedResourceDocument.LabelRelatedResource
    {
        private static final long serialVersionUID = 1L;
        
        public LabelRelatedResourceImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected LabelRelatedResourceImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
