 ...
 */
public class SourceNameLocationDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.SourceNameLocationDocument
{
    private static final long serialVersionUID = 1L;
    
    public SourceNameLocationDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName SOURCENAMELOCATION$0 = 
     ...
     */
    public de.zib.museum.museumdat.SourceNameLocationDocument.SourceNameLocation getSourceNameLocation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.SourceNameLocationDocument.SourceNameLocation target = null;
            target = (de.zib.museum.museumdat.SourceNameLocationDocument.SourceNameLocation)get_store().find_element_user(SOURCENAMELOCATION$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setSourceNameLocation(de.zib.museum.museumdat.SourceNameLocationDocument.SourceNameLocation sourceNameLocation)
    {
        generatedSetterHelperImpl(sourceNameLocation, SOURCENAMELOCATION$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public de.zib.museum.museumdat.SourceNameLocationDocument.SourceNameLocation addNewSourceNameLocation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.SourceNameLocationDocument.SourceNameLocation target = null;
            target = (de.zib.museum.museumdat.SourceNameLocationDocument.SourceNameLocation)get_store().add_element_user(SOURCENAMELOCATION$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class SourceNameLocationImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.SourceNameLocationDocument.SourceNameLocation
    {
        private static final long serialVersionUID = 1L;
        
        public SourceNameLocationImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected SourceNameLocationImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
