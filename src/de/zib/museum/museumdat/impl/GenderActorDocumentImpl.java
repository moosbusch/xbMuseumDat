 ...
 */
public class GenderActorDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.GenderActorDocument
{
    private static final long serialVersionUID = 1L;
    
    public GenderActorDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName GENDERACTOR$0 = 
    ...
    public de.zib.museum.museumdat.GenderActorDocument.GenderActor getGenderActor()
    {
        synchronized (monitor())
        {
            ...
            target = (de.zib.museum.museumdat.GenderActorDocument.GenderActor)get_store().find_element_user(GENDERACTOR$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(genderActor, GENDERACTOR$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public de.zib.museum.museumdat.GenderActorDocument.GenderActor addNewGenderActor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.GenderActorDocument.GenderActor target = null;
            target = (de.zib.museum.museumdat.GenderActorDocument.GenderActor)get_store().add_element_user(GENDERACTOR$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class GenderActorImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.GenderActorDocument.GenderActor
    {
        private static final long serialVersionUID = 1L;
        
        public GenderActorImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected GenderActorImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
