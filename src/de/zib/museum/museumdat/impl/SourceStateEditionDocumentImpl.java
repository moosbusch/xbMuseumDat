 ...
 */
public class SourceStateEditionDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.SourceStateEditionDocument
{
     ...
     */
    public de.zib.museum.museumdat.SourceStateEditionDocument.SourceStateEdition getSourceStateEdition()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.SourceStateEditionDocument.SourceStateEdition target = null;
            target = (de.zib.museum.museumdat.SourceStateEditionDocument.SourceStateEdition)get_store().find_element_user(SOURCESTATEEDITION$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setSourceStateEdition(de.zib.museum.museumdat.SourceStateEditionDocument.SourceStateEdition sourceStateEdition)
    {
        generatedSetterHelperImpl(sourceStateEdition, SOURCESTATEEDITION$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public de.zib.museum.museumdat.SourceStateEditionDocument.SourceStateEdition addNewSourceStateEdition()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.SourceStateEditionDocument.SourceStateEdition target = null;
            target = (de.zib.museum.museumdat.SourceStateEditionDocument.SourceStateEdition)get_store().add_element_user(SOURCESTATEEDITION$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class SourceStateEditionImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.SourceStateEditionDocument.SourceStateEdition
    {
        private static final long serialVersionUID = 1L;
        
        public SourceStateEditionImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected SourceStateEditionImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
