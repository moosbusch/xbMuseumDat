 ...
 */
public class DisplayEventDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.DisplayEventDocument
{
    private static final long serialVersionUID = 1L;
    
    public DisplayEventDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public de.zib.museum.museumdat.DisplayEventDocument.DisplayEvent getDisplayEvent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.DisplayEventDocument.DisplayEvent target = null;
            target = (de.zib.museum.museumdat.DisplayEventDocument.DisplayEvent)get_store().find_element_user(DISPLAYEVENT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setDisplayEvent(de.zib.museum.museumdat.DisplayEventDocument.DisplayEvent displayEvent)
    {
        generatedSetterHelperImpl(displayEvent, DISPLAYEVENT$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
     ...
     */
    public static class DisplayEventImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.DisplayEventDocument.DisplayEvent
    {
        private static final long serialVersionUID = 1L;
        
        public DisplayEventImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected DisplayEventImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
