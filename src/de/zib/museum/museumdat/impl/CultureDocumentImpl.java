 ...
 */
public class CultureDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.CultureDocument
{
     ...
     */
    public de.zib.museum.museumdat.CultureDocument.Culture getCulture()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.CultureDocument.Culture target = null;
            target = (de.zib.museum.museumdat.CultureDocument.Culture)get_store().find_element_user(CULTURE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public static class CultureImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.CultureDocument.Culture
    {
        private static final long serialVersionUID = 1L;
