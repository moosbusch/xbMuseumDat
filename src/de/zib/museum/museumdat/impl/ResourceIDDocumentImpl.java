 ...
 * Java type: de.zib.museum.museumdat.ResourceIDDocument
 *
 ...
 */
public class ResourceIDDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.ResourceIDDocument
{
    ...
    public de.zib.museum.museumdat.ResourceIDDocument.ResourceID getResourceID()
    {
        synchronized (monitor())
        {
            ...
            target = (de.zib.museum.museumdat.ResourceIDDocument.ResourceID)get_store().find_element_user(RESOURCEID$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public de.zib.museum.museumdat.ResourceIDDocument.ResourceID addNewResourceID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ResourceIDDocument.ResourceID target = null;
            target = (de.zib.museum.museumdat.ResourceIDDocument.ResourceID)get_store().add_element_user(RESOURCEID$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class ResourceIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.ResourceIDDocument.ResourceID
    {
        private static final long serialVersionUID = 1L;
