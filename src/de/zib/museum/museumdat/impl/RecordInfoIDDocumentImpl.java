 ...
 */
public class RecordInfoIDDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.RecordInfoIDDocument
{
     ...
     */
    public de.zib.museum.museumdat.RecordInfoIDDocument.RecordInfoID getRecordInfoID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.RecordInfoIDDocument.RecordInfoID target = null;
            target = (de.zib.museum.museumdat.RecordInfoIDDocument.RecordInfoID)get_store().find_element_user(RECORDINFOID$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setRecordInfoID(de.zib.museum.museumdat.RecordInfoIDDocument.RecordInfoID recordInfoID)
    {
     ...
     */
    public static class RecordInfoIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.RecordInfoIDDocument.RecordInfoID
    {
        private static final long serialVersionUID = 1L;
