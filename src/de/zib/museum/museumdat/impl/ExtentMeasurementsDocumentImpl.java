 ...
 */
public class ExtentMeasurementsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.ExtentMeasurementsDocument
{
     ...
     */
    public de.zib.museum.museumdat.ExtentMeasurementsDocument.ExtentMeasurements getExtentMeasurements()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ExtentMeasurementsDocument.ExtentMeasurements target = null;
            target = (de.zib.museum.museumdat.ExtentMeasurementsDocument.ExtentMeasurements)get_store().find_element_user(EXTENTMEASUREMENTS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setExtentMeasurements(de.zib.museum.museumdat.ExtentMeasurementsDocument.ExtentMeasurements extentMeasurements)
    {
        generatedSetterHelperImpl(extentMeasurements, EXTENTMEASUREMENTS$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public de.zib.museum.museumdat.ExtentMeasurementsDocument.ExtentMeasurements addNewExtentMeasurements()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ExtentMeasurementsDocument.ExtentMeasurements target = null;
            target = (de.zib.museum.museumdat.ExtentMeasurementsDocument.ExtentMeasurements)get_store().add_element_user(EXTENTMEASUREMENTS$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class ExtentMeasurementsImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.ExtentMeasurementsDocument.ExtentMeasurements
    {
        private static final long serialVersionUID = 1L;
