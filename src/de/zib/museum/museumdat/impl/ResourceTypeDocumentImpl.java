 ...
 */
public class ResourceTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.ResourceTypeDocument
{
     ...
     */
    public de.zib.museum.museumdat.ResourceTypeDocument.ResourceType getResourceType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ResourceTypeDocument.ResourceType target = null;
            target = (de.zib.museum.museumdat.ResourceTypeDocument.ResourceType)get_store().find_element_user(RESOURCETYPE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setResourceType(de.zib.museum.museumdat.ResourceTypeDocument.ResourceType resourceType)
    {
    ...
    public de.zib.museum.museumdat.ResourceTypeDocument.ResourceType addNewResourceType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ResourceTypeDocument.ResourceType target = null;
            target = (de.zib.museum.museumdat.ResourceTypeDocument.ResourceType)get_store().add_element_user(RESOURCETYPE$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class ResourceTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.ResourceTypeDocument.ResourceType
    {
        private static final long serialVersionUID = 1L;
