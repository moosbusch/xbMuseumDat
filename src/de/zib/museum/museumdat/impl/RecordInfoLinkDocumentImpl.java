 ...
 */
public class RecordInfoLinkDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.RecordInfoLinkDocument
{
     ...
     */
    public de.zib.museum.museumdat.RecordInfoLinkDocument.RecordInfoLink getRecordInfoLink()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.RecordInfoLinkDocument.RecordInfoLink target = null;
            target = (de.zib.museum.museumdat.RecordInfoLinkDocument.RecordInfoLink)get_store().find_element_user(RECORDINFOLINK$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setRecordInfoLink(de.zib.museum.museumdat.RecordInfoLinkDocument.RecordInfoLink recordInfoLink)
    {
        generatedSetterHelperImpl(recordInfoLink, RECORDINFOLINK$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public de.zib.museum.museumdat.RecordInfoLinkDocument.RecordInfoLink addNewRecordInfoLink()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.RecordInfoLinkDocument.RecordInfoLink target = null;
            target = (de.zib.museum.museumdat.RecordInfoLinkDocument.RecordInfoLink)get_store().add_element_user(RECORDINFOLINK$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class RecordInfoLinkImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.RecordInfoLinkDocument.RecordInfoLink
    {
        private static final long serialVersionUID = 1L;
        
        public RecordInfoLinkImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected RecordInfoLinkImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
