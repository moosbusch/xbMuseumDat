 ...
 */
public class TermMaterialsTechDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.TermMaterialsTechDocument
{
     ...
     */
    public de.zib.museum.museumdat.TermMaterialsTechDocument.TermMaterialsTech getTermMaterialsTech()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.TermMaterialsTechDocument.TermMaterialsTech target = null;
            target = (de.zib.museum.museumdat.TermMaterialsTechDocument.TermMaterialsTech)get_store().find_element_user(TERMMATERIALSTECH$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setTermMaterialsTech(de.zib.museum.museumdat.TermMaterialsTechDocument.TermMaterialsTech termMaterialsTech)
    {
     ...
     */
    public static class TermMaterialsTechImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.TermMaterialsTechDocument.TermMaterialsTech
    {
        private static final long serialVersionUID = 1L;
