 ...
 */
public class ResourceViewSubjectTermDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.ResourceViewSubjectTermDocument
{
     ...
     */
    public de.zib.museum.museumdat.ResourceViewSubjectTermDocument.ResourceViewSubjectTerm getResourceViewSubjectTerm()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ResourceViewSubjectTermDocument.ResourceViewSubjectTerm target = null;
            target = (de.zib.museum.museumdat.ResourceViewSubjectTermDocument.ResourceViewSubjectTerm)get_store().find_element_user(RESOURCEVIEWSUBJECTTERM$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setResourceViewSubjectTerm(de.zib.museum.museumdat.ResourceViewSubjectTermDocument.ResourceViewSubjectTerm resourceViewSubjectTerm)
    {
    ...
    public de.zib.museum.museumdat.ResourceViewSubjectTermDocument.ResourceViewSubjectTerm addNewResourceViewSubjectTerm()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ResourceViewSubjectTermDocument.ResourceViewSubjectTerm target = null;
            target = (de.zib.museum.museumdat.ResourceViewSubjectTermDocument.ResourceViewSubjectTerm)get_store().add_element_user(RESOURCEVIEWSUBJECTTERM$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class ResourceViewSubjectTermImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.ResourceViewSubjectTermDocument.ResourceViewSubjectTerm
    {
        private static final long serialVersionUID = 1L;
