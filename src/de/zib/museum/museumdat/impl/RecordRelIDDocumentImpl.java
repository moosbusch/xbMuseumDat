 ...
 */
public class RecordRelIDDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.RecordRelIDDocument
{
     ...
     */
    public de.zib.museum.museumdat.RecordRelIDDocument.RecordRelID getRecordRelID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.RecordRelIDDocument.RecordRelID target = null;
            target = (de.zib.museum.museumdat.RecordRelIDDocument.RecordRelID)get_store().find_element_user(RECORDRELID$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setRecordRelID(de.zib.museum.museumdat.RecordRelIDDocument.RecordRelID recordRelID)
    {
    ...
    public de.zib.museum.museumdat.RecordRelIDDocument.RecordRelID addNewRecordRelID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.RecordRelIDDocument.RecordRelID target = null;
            target = (de.zib.museum.museumdat.RecordRelIDDocument.RecordRelID)get_store().add_element_user(RECORDRELID$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class RecordRelIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.RecordRelIDDocument.RecordRelID
    {
        private static final long serialVersionUID = 1L;
