 ...
 */
public class RightsResourceDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.RightsResourceDocument
{
     ...
     */
    public de.zib.museum.museumdat.RightsResourceDocument.RightsResource getRightsResource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.RightsResourceDocument.RightsResource target = null;
            target = (de.zib.museum.museumdat.RightsResourceDocument.RightsResource)get_store().find_element_user(RIGHTSRESOURCE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setRightsResource(de.zib.museum.museumdat.RightsResourceDocument.RightsResource rightsResource)
    {
    ...
    public de.zib.museum.museumdat.RightsResourceDocument.RightsResource addNewRightsResource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.RightsResourceDocument.RightsResource target = null;
            target = (de.zib.museum.museumdat.RightsResourceDocument.RightsResource)get_store().add_element_user(RIGHTSRESOURCE$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class RightsResourceImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.RightsResourceDocument.RightsResource
    {
        private static final long serialVersionUID = 1L;
