 ...
 */
public class ResourceViewDescriptionDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.ResourceViewDescriptionDocument
{
    ...
    public de.zib.museum.museumdat.ResourceViewDescriptionDocument.ResourceViewDescription getResourceViewDescription()
    {
        synchronized (monitor())
        {
            ...
            target = (de.zib.museum.museumdat.ResourceViewDescriptionDocument.ResourceViewDescription)get_store().find_element_user(RESOURCEVIEWDESCRIPTION$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public de.zib.museum.museumdat.ResourceViewDescriptionDocument.ResourceViewDescription addNewResourceViewDescription()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ResourceViewDescriptionDocument.ResourceViewDescription target = null;
            target = (de.zib.museum.museumdat.ResourceViewDescriptionDocument.ResourceViewDescription)get_store().add_element_user(RESOURCEVIEWDESCRIPTION$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class ResourceViewDescriptionImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.ResourceViewDescriptionDocument.ResourceViewDescription
    {
        private static final long serialVersionUID = 1L;
