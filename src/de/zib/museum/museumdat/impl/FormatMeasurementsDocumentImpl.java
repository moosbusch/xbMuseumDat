 ...
 */
public class FormatMeasurementsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.FormatMeasurementsDocument
{
     ...
     */
    public de.zib.museum.museumdat.FormatMeasurementsDocument.FormatMeasurements getFormatMeasurements()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.FormatMeasurementsDocument.FormatMeasurements target = null;
            target = (de.zib.museum.museumdat.FormatMeasurementsDocument.FormatMeasurements)get_store().find_element_user(FORMATMEASUREMENTS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setFormatMeasurements(de.zib.museum.museumdat.FormatMeasurementsDocument.FormatMeasurements formatMeasurements)
    {
        generatedSetterHelperImpl(formatMeasurements, FORMATMEASUREMENTS$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public de.zib.museum.museumdat.FormatMeasurementsDocument.FormatMeasurements addNewFormatMeasurements()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.FormatMeasurementsDocument.FormatMeasurements target = null;
            target = (de.zib.museum.museumdat.FormatMeasurementsDocument.FormatMeasurements)get_store().add_element_user(FORMATMEASUREMENTS$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class FormatMeasurementsImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.FormatMeasurementsDocument.FormatMeasurements
    {
        private static final long serialVersionUID = 1L;
