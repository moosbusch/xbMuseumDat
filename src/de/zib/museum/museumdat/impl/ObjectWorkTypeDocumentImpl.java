 ...
 */
public class ObjectWorkTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.ObjectWorkTypeDocument
{
     ...
     */
    public de.zib.museum.museumdat.ObjectWorkTypeDocument.ObjectWorkType getObjectWorkType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ObjectWorkTypeDocument.ObjectWorkType target = null;
            target = (de.zib.museum.museumdat.ObjectWorkTypeDocument.ObjectWorkType)get_store().find_element_user(OBJECTWORKTYPE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setObjectWorkType(de.zib.museum.museumdat.ObjectWorkTypeDocument.ObjectWorkType objectWorkType)
    {
     ...
     */
    public static class ObjectWorkTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.ObjectWorkTypeDocument.ObjectWorkType
    {
        private static final long serialVersionUID = 1L;
