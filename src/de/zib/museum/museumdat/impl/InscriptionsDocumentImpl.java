 ...
 */
public class InscriptionsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.InscriptionsDocument
{
     ...
     */
    public de.zib.museum.museumdat.InscriptionsDocument.Inscriptions getInscriptions()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.InscriptionsDocument.Inscriptions target = null;
            target = (de.zib.museum.museumdat.InscriptionsDocument.Inscriptions)get_store().find_element_user(INSCRIPTIONS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public static class InscriptionsImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.InscriptionsDocument.Inscriptions
    {
        private static final long serialVersionUID = 1L;
        ...
        protected InscriptionsImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
