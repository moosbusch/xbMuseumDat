 ...
 */
public class DisplayEditionDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.DisplayEditionDocument
{
     ...
     */
    public de.zib.museum.museumdat.DisplayEditionDocument.DisplayEdition getDisplayEdition()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.DisplayEditionDocument.DisplayEdition target = null;
            target = (de.zib.museum.museumdat.DisplayEditionDocument.DisplayEdition)get_store().find_element_user(DISPLAYEDITION$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setDisplayEdition(de.zib.museum.museumdat.DisplayEditionDocument.DisplayEdition displayEdition)
    {
        generatedSetterHelperImpl(displayEdition, DISPLAYEDITION$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public de.zib.museum.museumdat.DisplayEditionDocument.DisplayEdition addNewDisplayEdition()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.DisplayEditionDocument.DisplayEdition target = null;
            target = (de.zib.museum.museumdat.DisplayEditionDocument.DisplayEdition)get_store().add_element_user(DISPLAYEDITION$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class DisplayEditionImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.DisplayEditionDocument.DisplayEdition
    {
        private static final long serialVersionUID = 1L;
        
        public DisplayEditionImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected DisplayEditionImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
