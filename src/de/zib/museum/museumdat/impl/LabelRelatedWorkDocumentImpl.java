 ...
 */
public class LabelRelatedWorkDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.LabelRelatedWorkDocument
{
     ...
     */
    public de.zib.museum.museumdat.LabelRelatedWorkDocument.LabelRelatedWork getLabelRelatedWork()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.LabelRelatedWorkDocument.LabelRelatedWork target = null;
            target = (de.zib.museum.museumdat.LabelRelatedWorkDocument.LabelRelatedWork)get_store().find_element_user(LABELRELATEDWORK$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setLabelRelatedWork(de.zib.museum.museumdat.LabelRelatedWorkDocument.LabelRelatedWork labelRelatedWork)
    {
        generatedSetterHelperImpl(labelRelatedWork, LABELRELATEDWORK$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public de.zib.museum.museumdat.LabelRelatedWorkDocument.LabelRelatedWork addNewLabelRelatedWork()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.LabelRelatedWorkDocument.LabelRelatedWork target = null;
            target = (de.zib.museum.museumdat.LabelRelatedWorkDocument.LabelRelatedWork)get_store().add_element_user(LABELRELATEDWORK$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class LabelRelatedWorkImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.LabelRelatedWorkDocument.LabelRelatedWork
    {
        private static final long serialVersionUID = 1L;
        
        public LabelRelatedWorkImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected LabelRelatedWorkImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
