 ...
 */
public class RelatedWorkRelTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.RelatedWorkRelTypeDocument
{
    ...
    public de.zib.museum.museumdat.RelatedWorkRelTypeDocument.RelatedWorkRelType getRelatedWorkRelType()
    {
        synchronized (monitor())
        {
            ...
            target = (de.zib.museum.museumdat.RelatedWorkRelTypeDocument.RelatedWorkRelType)get_store().find_element_user(RELATEDWORKRELTYPE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(relatedWorkRelType, RELATEDWORKRELTYPE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public de.zib.museum.museumdat.RelatedWorkRelTypeDocument.RelatedWorkRelType addNewRelatedWorkRelType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.RelatedWorkRelTypeDocument.RelatedWorkRelType target = null;
            target = (de.zib.museum.museumdat.RelatedWorkRelTypeDocument.RelatedWorkRelType)get_store().add_element_user(RELATEDWORKRELTYPE$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class RelatedWorkRelTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.RelatedWorkRelTypeDocument.RelatedWorkRelType
    {
        private static final long serialVersionUID = 1L;
        
        public RelatedWorkRelTypeImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected RelatedWorkRelTypeImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
