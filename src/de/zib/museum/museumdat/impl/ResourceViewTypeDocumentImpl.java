 ...
 */
public class ResourceViewTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.ResourceViewTypeDocument
{
     ...
     */
    public de.zib.museum.museumdat.ResourceViewTypeDocument.ResourceViewType getResourceViewType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ResourceViewTypeDocument.ResourceViewType target = null;
            target = (de.zib.museum.museumdat.ResourceViewTypeDocument.ResourceViewType)get_store().find_element_user(RESOURCEVIEWTYPE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setResourceViewType(de.zib.museum.museumdat.ResourceViewTypeDocument.ResourceViewType resourceViewType)
    {
    ...
    public de.zib.museum.museumdat.ResourceViewTypeDocument.ResourceViewType addNewResourceViewType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ResourceViewTypeDocument.ResourceViewType target = null;
            target = (de.zib.museum.museumdat.ResourceViewTypeDocument.ResourceViewType)get_store().add_element_user(RESOURCEVIEWTYPE$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class ResourceViewTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.ResourceViewTypeDocument.ResourceViewType
    {
        private static final long serialVersionUID = 1L;
