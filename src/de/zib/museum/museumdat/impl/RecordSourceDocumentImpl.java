 ...
 */
public class RecordSourceDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.RecordSourceDocument
{
     ...
     */
    public de.zib.museum.museumdat.RecordSourceDocument.RecordSource getRecordSource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.RecordSourceDocument.RecordSource target = null;
            target = (de.zib.museum.museumdat.RecordSourceDocument.RecordSource)get_store().find_element_user(RECORDSOURCE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setRecordSource(de.zib.museum.museumdat.RecordSourceDocument.RecordSource recordSource)
    {
        generatedSetterHelperImpl(recordSource, RECORDSOURCE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public de.zib.museum.museumdat.RecordSourceDocument.RecordSource addNewRecordSource()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.RecordSourceDocument.RecordSource target = null;
            target = (de.zib.museum.museumdat.RecordSourceDocument.RecordSource)get_store().add_element_user(RECORDSOURCE$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class RecordSourceImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.RecordSourceDocument.RecordSource
    {
        private static final long serialVersionUID = 1L;
        ...
        protected RecordSourceImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
