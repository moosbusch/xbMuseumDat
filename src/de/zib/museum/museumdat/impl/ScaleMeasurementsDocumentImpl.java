 ...
 */
public class ScaleMeasurementsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.ScaleMeasurementsDocument
{
     ...
     */
    public de.zib.museum.museumdat.ScaleMeasurementsDocument.ScaleMeasurements getScaleMeasurements()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ScaleMeasurementsDocument.ScaleMeasurements target = null;
            target = (de.zib.museum.museumdat.ScaleMeasurementsDocument.ScaleMeasurements)get_store().find_element_user(SCALEMEASUREMENTS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setScaleMeasurements(de.zib.museum.museumdat.ScaleMeasurementsDocument.ScaleMeasurements scaleMeasurements)
    {
        generatedSetterHelperImpl(scaleMeasurements, SCALEMEASUREMENTS$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public de.zib.museum.museumdat.ScaleMeasurementsDocument.ScaleMeasurements addNewScaleMeasurements()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ScaleMeasurementsDocument.ScaleMeasurements target = null;
            target = (de.zib.museum.museumdat.ScaleMeasurementsDocument.ScaleMeasurements)get_store().add_element_user(SCALEMEASUREMENTS$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class ScaleMeasurementsImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.ScaleMeasurementsDocument.ScaleMeasurements
    {
        private static final long serialVersionUID = 1L;
