 ...
 */
public class DisplayCreatorDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.DisplayCreatorDocument
{
     ...
     */
    public static class DisplayCreatorImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.DisplayCreatorDocument.DisplayCreator
    {
        private static final long serialVersionUID = 1L;

        public DisplayCreatorImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }

        protected DisplayCreatorImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
