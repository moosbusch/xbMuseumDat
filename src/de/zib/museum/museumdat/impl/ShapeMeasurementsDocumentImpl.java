 ...
 */
public class ShapeMeasurementsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.ShapeMeasurementsDocument
{
     ...
     */
    public de.zib.museum.museumdat.ShapeMeasurementsDocument.ShapeMeasurements getShapeMeasurements()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ShapeMeasurementsDocument.ShapeMeasurements target = null;
            target = (de.zib.museum.museumdat.ShapeMeasurementsDocument.ShapeMeasurements)get_store().find_element_user(SHAPEMEASUREMENTS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setShapeMeasurements(de.zib.museum.museumdat.ShapeMeasurementsDocument.ShapeMeasurements shapeMeasurements)
    {
        generatedSetterHelperImpl(shapeMeasurements, SHAPEMEASUREMENTS$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public de.zib.museum.museumdat.ShapeMeasurementsDocument.ShapeMeasurements addNewShapeMeasurements()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.ShapeMeasurementsDocument.ShapeMeasurements target = null;
            target = (de.zib.museum.museumdat.ShapeMeasurementsDocument.ShapeMeasurements)get_store().add_element_user(SHAPEMEASUREMENTS$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class ShapeMeasurementsImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.ShapeMeasurementsDocument.ShapeMeasurements
    {
        private static final long serialVersionUID = 1L;
