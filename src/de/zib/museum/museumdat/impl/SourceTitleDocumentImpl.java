 ...
 */
public class SourceTitleDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements de.zib.museum.museumdat.SourceTitleDocument
{
     ...
     */
    public de.zib.museum.museumdat.SourceTitleDocument.SourceTitle getSourceTitle()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.SourceTitleDocument.SourceTitle target = null;
            target = (de.zib.museum.museumdat.SourceTitleDocument.SourceTitle)get_store().find_element_user(SOURCETITLE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    @Inject(optional=true) public void setSourceTitle(de.zib.museum.museumdat.SourceTitleDocument.SourceTitle sourceTitle)
    {
        generatedSetterHelperImpl(sourceTitle, SOURCETITLE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public de.zib.museum.museumdat.SourceTitleDocument.SourceTitle addNewSourceTitle()
    {
        synchronized (monitor())
        {
            check_orphaned();
            de.zib.museum.museumdat.SourceTitleDocument.SourceTitle target = null;
            target = (de.zib.museum.museumdat.SourceTitleDocument.SourceTitle)get_store().add_element_user(SOURCETITLE$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class SourceTitleImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements de.zib.museum.museumdat.SourceTitleDocument.SourceTitle
    {
        private static final long serialVersionUID = 1L;
        
        public SourceTitleImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected SourceTitleImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
